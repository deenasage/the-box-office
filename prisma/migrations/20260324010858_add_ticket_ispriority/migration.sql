...
INSERT INTO "new_Ticket" ("assigneeId", "briefId", "createdAt", "creatorId", "description", "dueDate", "epicId", "formData", "id", "priority", "requiredSkillsetId", "size", "sprintId", "status", "team", "templateId", "title", "updatedAt") SELECT "assigneeId", "briefId", "createdAt", "creatorId", "description", "dueDate", "epicId", "formData", "id", "priority", "requiredSkillsetId", "size", "sprintId", "status", "team", "templateId", "title", "updatedAt" FROM "Ticket";
DROP TABLE "Ticket";
