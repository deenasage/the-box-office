...
function PlanningTab() {
  ...
  // Aggregate summary across all teams
  const totalCapacity = data?.teams.reduce((s, t) => s + t.totalCapacity, 0) ?? 0;
  const totalCommitted = data?.teams.reduce((s, t) => s + t.totalCommitted, 0) ?? 0;
    ...
    <div className="space-y-5">
      ...
      {data && (
        <div className="space-y-4">
          ...
          {data.teams.every((t) => t.members.length === 0) && (
